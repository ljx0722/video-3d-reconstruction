    ...
    <header className="border-b border-gray-800 bg-gray-950/80 backdrop-blur sticky top-0 z-50">
      <div className="max-w-[1600px] mx-auto px-4 h-12 flex items-center justify-between gap-4">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <span className="hidden md:block min-w-0 truncate whitespace-nowrap text-xs text-gray-400">
            上海长晴人工智能科技有限公司 · Changqing AI Technology (Shanghai) Co., Ltd. · 产品开发：长晴科技 Liujinxiu · 系统时间（北京时间）：{beijingTime}
          </span>
        </div>
